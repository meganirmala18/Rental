					...
					<div class="card">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="exampleInputName1" placeholder="plat" name="plat">
							</div>
							<div class="form-group">
								<label for="exampleInputName1">Merk</label>
								<input type="text" class="form-control" id="exampleInputName1" placeholder="Merk Kendaraan" name="merk">
							</div>
							<div class="form-group">
								<label for="exampleInputName1">Harga Sewa/Hari</label>
								<input type="text" class="form-control" id="exampleInputName1" placeholder="Harga Sewa Kendaraan" name="hargasewa">
							</div>
